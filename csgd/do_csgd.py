...
if __name__ == '__main__':
    ...
    if network_type == 'sres50':
        ...
        succeeding_strategy = resnet_bottleneck_succeeding_strategy(50)  # 获取每层后层 id 作为字典 如：{2: 3, 3: 4, 5: 6, 6: 7, 8: 9, 9: 10, 12: 13, 13: 14, 15: 16, 16: 17, 18: 19, 19: 20, 21: 22, 22: 23, ...}
        pacesetter_dict = resnet_bottleneck_follow_dict(50)  # {1: 1, 4: 1, 7: 1, 10: 1, 11: 11, 14: 11, 17: 11, 20: 11, 23: 11, 24: 24, 27: 24, 30: 24, 33: 24, 36: 24, ...}
